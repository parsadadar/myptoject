...
class product(models.Model):
    ...
    images = models.ImageField(upload_to='/', verbose_name='عکس محصول')
    ...
    categories = models.ManyToManyField(subcategory, on_delete=models.SET_NULL, null=True, verbose_name='دست بندی')